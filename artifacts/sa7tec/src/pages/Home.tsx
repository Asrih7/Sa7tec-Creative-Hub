  ...
  return (
    <PublicLayout>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-20 overflow-hidden">
        ...
        {/* Generated Image Background (Mesh/Hexagons) */}
        <div 
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold leading-tight mb-6 text-white">
              {content.siteInfo.heroHeadline.split(' ').map((word, i) => (
                word.toLowerCase() === 'matter' ? (
            ...
            <p className="text-xl md:text-2xl text-slate-300 mb-10 max-w-2xl mx-auto font-light leading-relaxed">
              {content.siteInfo.heroSubheadline}
            </p>
      ...
      <section className="py-24 relative bg-card/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-display font-bold mb-4">What We Build</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">From addictive games to enterprise tools, we engineer solutions that perform.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                The ultimate puzzle challenge with over 5,000 levels. Match colors, beat the clock, and rise up the global leaderboards in this visually stunning brain teaser.
              </p>
              
              <ul className="space-y-4 mb-10">
                {['5,000+ Unique Levels', 'Neon Dark Mode Aesthetic', 'Global Leaderboards', 'Daily Challenges'].map((feature, i) => (
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-display font-bold mb-4">Our Portfolio</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">Beyond games, we craft beautiful utility apps for forward-thinking brands.</p>
          </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-border">
            {content.stats.map((stat, i) => (
              ...
              >
                <div className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-white mb-2">{stat.value}</div>
                <div className="text-sm md:text-base text-primary uppercase tracking-widest font-semibold">{stat.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 relative">
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-display font-bold mb-4">How We Work</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">A streamlined process to turn your vision into a digital reality.</p>
          </div>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="glass-panel border-primary/20 bg-[#132442]/80 p-12 md:p-20 rounded-[3rem] text-center max-w-5xl mx-auto shadow-[0_0_50px_-12px_hsl(var(--primary))]">
            <h2 className="text-4xl md:text-6xl font-display font-bold mb-6">Ready to Build?</h2>
            <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              Whether it's the next hit puzzle game or a complex enterprise tool, we have the team to make it happen.
            </p>
            <Link href="/contact">
